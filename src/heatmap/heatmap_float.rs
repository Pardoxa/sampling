...
impl<HistWidth, HistHeight> From<HeatmapU<HistWidth, HistHeight>>
    for HeatmapF64<HistWidth, HistHeight>
where
    HistWidth: Histogram,
    HistHeight: Histogram,
{
    fn from(other: HeatmapU<HistWidth, HistHeight>) -> Self {
        ...
        heatmap.extend(other.heatmap().iter().map(|&val| val as f64));
        Self {
            heatmap,
            width: other.width,
            height: other.height,
    ...
    HistHeight: Histogram,
{
        ...
        W: std::io::Write,
    {
        ...
        let default = d.terminal(GnuplotTerminal::Empty);
        self.gnuplot(writer, default)
    }
