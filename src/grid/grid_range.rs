...
impl GridRangeF64{
    ...
    /// `step_m1` number of steps minus 1. i.e., the iterator will return `steps_m1 + 1` items
    pub fn new(
        start: f64,
        end: f64, 
        steps_m1: NonZeroUsize
...
mod grid_range_tests
{
    ...
    #[test]
    fn range_test(){
        let range = GridRangeF64::new(0.0, 1.0, NonZeroUsize::new(2).unwrap());
    ...
    fn random_range_tests()
    {
        ...
        for _ in 0..1000 {
            ...
            let range = GridRangeF64::new(left, right, steps_m1);
    ...
    fn nth_test()
    {
        let range = GridRangeF64::new(0.0, 23.128273958759, NonZeroUsize::new(123321).unwrap());
        let mut iter = range.iter();
